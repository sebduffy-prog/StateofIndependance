/**
 * 20-move-mentalload.js — WORKFLOW A branded placeholder (see docs/STRUCTURE-V2.md).
 *
 ...
 *
 * Contract: docs/CONTRACT.md. Every CSS selector scoped to #\32 0-move-mentalload.
 *
 * @param {HTMLElement} rootEl  the <section class="journey-stage" id="20-move-mentalload">
