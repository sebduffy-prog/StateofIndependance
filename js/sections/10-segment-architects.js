/**
 * 10-segment-architects.js — WORKFLOW A branded placeholder (see docs/STRUCTURE-V2.md).
 *
 ...
 *
 * @param {HTMLElement} rootEl  the <section class="journey-stage" id="10-segment-architects">
