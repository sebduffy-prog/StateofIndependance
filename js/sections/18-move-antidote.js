/**
 * 18-move-antidote.js — WORKFLOW A branded placeholder (see docs/STRUCTURE-V2.md).
 *
 ...
 *
 * Contract: docs/CONTRACT.md. Every CSS selector scoped to #\31 8-move-antidote.
 *
 * @param {HTMLElement} rootEl  the <section class="journey-stage" id="18-move-antidote">
