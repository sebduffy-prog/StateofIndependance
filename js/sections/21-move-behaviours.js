/**
 * 21-move-behaviours.js — WORKFLOW A branded placeholder (see docs/STRUCTURE-V2.md).
 *
 ...
 *
 * Contract: docs/CONTRACT.md. Every CSS selector scoped to #\32 1-move-behaviours.
 *
 * @param {HTMLElement} rootEl  the <section class="journey-stage" id="21-move-behaviours">
