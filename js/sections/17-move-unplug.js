/**
 * 17-move-unplug.js — WORKFLOW A branded placeholder (see docs/STRUCTURE-V2.md).
 *
 ...
 *
 * Contract: docs/CONTRACT.md. Every CSS selector scoped to #\31 7-move-unplug.
 *
 * @param {HTMLElement} rootEl  the <section class="journey-stage" id="17-move-unplug">
